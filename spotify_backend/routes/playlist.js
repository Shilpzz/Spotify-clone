...
// /something1/something/something3 ---> exact match
// /something1/something2/something4 ---> this will not call the api on the previous line.
// If we are doing /playlist/get/:playlistId (focus on :) --> this means that playlistId is now a variable to which we can assign any valu.
// If you call anything of the format /playlist/get/abcdefgh (abcdefgh can be anything), this api is called.
// If you called /playlist/get/abcdefgh, the playlistId variable gets aasigned the value abcdefgh.
...
async (req, res) => {
    ...
    // Step 1: Check if currentUser owns the playlist or is a collaborators
    if(
